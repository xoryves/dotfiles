#!/bin/bash
# https://gist.github.com/bikram990/864709e6b41e7459195bcbc5af316cb2
...
for ((uid = 500; ; --uid)); do
  if ! id -u $uid &>/dev/null; then
    if ! dscl /Local/Default -ls Groups gid | grep -q [^0-9]$uid\$; then
      ...
      dscl /Local/Default -create Users/_$username UserShell /bin/zsh
      ...
      # createhomedir -u _$username
      mkdir /Users/_$username
      chown $uid:$uid /Users/_$username
      break
    fi
  fi
done
